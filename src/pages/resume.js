              ...
              <p style={{ fontSize: '1.125rem' }}>
                <table>
                  <tr valign="top">
                    <td align="right">[1]</td>
                    <td class="bibtexitem">
                      <b>Se&aacute;n&nbsp;K Martin</b>, John&nbsp;P Aggleton,
                      and Shane&nbsp;M O’Mara. Can we conjointly record direct
                      interactions between neurons in vivo in
                      anatomically-connected brain areas? Probabilistic analyses
                      and further implications. <em>Preprint on bioRxiv</em>,
                      2020. [&nbsp;
